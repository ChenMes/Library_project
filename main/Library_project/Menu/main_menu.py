from main.Library_project.Menu.customers import add_new_customer, display_all_customers, find_customer_by_name, \
    remove_customer_from_the_library

from main.Library_project.Menu.books import add_new_book, display_all_books, find_books_by_name, find_books_by_author, \
    remove_book_from_the_library
from main.Library_project.Menu.loans import loan_a_book, return_a_book, display_all_loans, display_all_the_late_loans, \
